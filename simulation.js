...
const IMG = {
    ...
    materiales: [
        ...
        { src: GITHUB_BASE + 'Imagenes/Materiales/Tubo_de_ensayo_de_15_ml.png', name: '1 tubo de ensayo 15 ml' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Licuadora.png', name: '1 licuadora' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Gradilla.png', name: '1 gradilla' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Embudo1.png', name: '1 embudo' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Varillas_de_cristal.png', name: '4 varillas de cristal' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Filtros_de_café.png', name: '1 filtro de café' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Sal_sin_yodo_20g.png', name: 'Sal sin yodo (20 g)' },
        { src: GITHUB_BASE + 'Imagenes/Materiales/Ablandador_de_carne_5g.png', name: 'Ablandador de carne (5 g)' },
